...
function VirtualSolutions() {
  return (
    <div className="p-5 md:px-10 md:py-12 flex flex-col justify-center items-center">
      ...
      <p className="text-zinc-800 text-center text-base mt-7 max-md:max-w-full [text-wrap:balance]" >
